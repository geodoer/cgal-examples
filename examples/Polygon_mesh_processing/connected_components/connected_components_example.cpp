/*
 *\referneces
    https://doc.cgal.org/latest/Polygon_mesh_processing/Polygon_mesh_processing_2connected_components_example_8cpp-example.html#a7
 */
...
{
  const std::string filename = (argc > 1) ? argv[1] : DATA_PATH "blobby_3cc.off";
